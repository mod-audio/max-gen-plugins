...
#define DISTRHO_PLUGIN_NAME    "Toggle_2IN"
#define DISTRHO_PLUGIN_URI     "urn:maxgen:zwabo:toggle_2in"
#define DISTRHO_PLUGIN_CLAP_ID "maxgen.zwabo.toggle_2in"
...
#define DISTRHO_PLUGIN_UNIQUE_ID d_cconst('z', 'w', 't', '2')
