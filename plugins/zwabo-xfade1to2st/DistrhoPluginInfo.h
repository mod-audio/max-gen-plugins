...
#define DISTRHO_PLUGIN_NAME    "Xfade1to2st"
#define DISTRHO_PLUGIN_URI     "urn:maxgen:zwabo:xfade1to2st"
#define DISTRHO_PLUGIN_CLAP_ID "maxgen.zwabo.xfade1to2st"
...
#define DISTRHO_PLUGIN_UNIQUE_ID d_cconst('z', 'w', 'x', 'f')
