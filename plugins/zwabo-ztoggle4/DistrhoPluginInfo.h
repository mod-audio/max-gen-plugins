...
#define DISTRHO_PLUGIN_NAME    "Ztoggle4"
#define DISTRHO_PLUGIN_URI     "urn:maxgen:zwabo:ztoggle4"
#define DISTRHO_PLUGIN_CLAP_ID "maxgen.zwabo.ztoggle4"
...
#define DISTRHO_PLUGIN_UNIQUE_ID d_cconst('z', 'w', 't', '4')
