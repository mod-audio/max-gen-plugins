...
#define DISTRHO_PLUGIN_NAME    "Zinvert_phase"
#define DISTRHO_PLUGIN_URI     "urn:maxgen:zwabo:zinvert_phase"
#define DISTRHO_PLUGIN_CLAP_ID "maxgen.zwabo.zinvert_phase"
...
#define DISTRHO_PLUGIN_UNIQUE_ID d_cconst('z', 'w', 'i', 'p')
