...
#define DISTRHO_PLUGIN_NAME    "COZMIC"
#define DISTRHO_PLUGIN_URI     "urn:maxgen:zwabo:cozmic"
#define DISTRHO_PLUGIN_CLAP_ID "maxgen.zwabo.cozmic"
...
#define DISTRHO_PLUGIN_UNIQUE_ID d_cconst('z', 'w', 'c', 'z')
